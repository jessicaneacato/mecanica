...
Public Class ReporteReparaciones
    Public idCliente
    ...
    Private Sub ReporteReparaciones_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub Cargar_Datos()
        Try
            conexion.Open()
            Dim da As New SqlClient.SqlDataAdapter("SELECT * FROM V_Reparaciones", conexion)
