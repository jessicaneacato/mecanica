...
Public Class ClientesCompras
    ...
    Private Sub ClientesCompras_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub Cargar_Datos()
        Try
            conexion.Open()
            Dim da As New SqlClient.SqlDataAdapter("SELECT * FROM V_Ventas WHERE id_cliente=@cliente_id", conexion)
