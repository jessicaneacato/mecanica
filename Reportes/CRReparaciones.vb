...
Public Class CRReparaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Mecanica.CRReparaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRReparaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRReparaciones = New CRReparaciones
        rpt.Site = Me.Site
        Return rpt
    End Function
